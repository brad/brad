...
PDFJS.imageResourcesPath = '/assets/js/vendor/pdfjs/web/images/';
  PDFJS.workerSrc = '/assets/js/vendor/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = '/assets/js/vendor/pdfjs/web/cmaps/';
